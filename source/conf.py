...
project = 'ManimGL'
copyright = '2020-2025 Manim Kindergarten Team'
...
html_css_files = [
    # "https://g.565455.xyz/manim-file/manimgl_assets/custom.css", 
    "https://g.565455.xyz/manim-file/manimgl_assets/colors.css",
    "custom.css"
]
